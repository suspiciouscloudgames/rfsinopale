...
import {getPromptCatalog,shuffledPrompts} from '../desktop/tablet/blackout-prompts.js'
import {getBlackoutLocale,composeInLocale} from '../desktop/tablet/blackout-locales.js'
import {promptTexts,promptIndices} from '../desktop/tablet/blackout-prompt-texts.js'
